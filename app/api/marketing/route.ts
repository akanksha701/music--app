...
export async function GET() {
  try {
    ...
    const footerContent = [
      ...
      {
        title: "Learn",
        links: ["About Us", "Licenses", "Terms of Use", "Sportify Policy"],
      },
      {
        title: "Let's Work",
        links: [
    ...
    const views = [
      { title: "Explore the world's leading Sportify library for soundtracks" ,viewImg:"https://plus.unsplash.com/premium_photo-1663957831645-e683bddec89a?q=80&w=2930&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
      {
        views: [
