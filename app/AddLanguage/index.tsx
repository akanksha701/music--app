...
const Index = () => {
  ...
  const { data: languageData, error: isErrorLanguage, isLoading:isLanguagesLoading } = useGetLanguageQuery({ page, recordsPerPage });

  if (!languageData || isErrorLanguage || isLanguagesLoading) {
    return <></>;
  }
