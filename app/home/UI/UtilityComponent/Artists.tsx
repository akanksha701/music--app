  ...
  return (
    <>
      <div className="w-full mt-10 flex flex-col items-center justify-center rounded-md">
        ...
        <div
          className="rounded-md h-[500px] w-full sm:w-[300px] md:w-[350px] lg:w-[1050px] 
        p-10 bg-yellow-500 bg-opacity-25 opacity-100 overflow-y-auto scroll-smooth mt-10  
        grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5 gap-4 items-center justify-center"
        >
          {artistsData.map((artist, index) => {
            ...
            return (
              <Card
                ...
                className={`${bgColor} cursor-pointer outline-dashed outline-offset-5 outline-indigo-600 
              hover:translate-y-1 rounded-md`}
              >
