'use client';
import AddGenre from '@/app/(ProfilePage)/LanguageAndGenre/UtilityComponent/AddGenre';
import AddLanguage from '@/app/(ProfilePage)/LanguageAndGenre/UtilityComponent/AddLanguage';
