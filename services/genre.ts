...
export const genreApi : any = createApi({
...
export const { useGetGenreQuery, useAddGenreMutation, useGetAllGenreQuery , useUpdateGenreMutation , useDeleteGenreMutation } = genreApi;
