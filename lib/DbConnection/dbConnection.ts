...
const uri = process.env.MONGODB_URI || 'MONGODB_URI=mongodb+srv://akanksha:root@cluster0.ent1u.mongodb.net/music-matter?retryWrites=true&w=majority&appName=Cluster0';
const options = {};
